...
/** Sélection locale de fichiers : aucun upload serveur n'est effectué. */
  ...
  return (
    <div className="space-y-3">
      <div
        ...
        className={cn(
          "flex flex-col items-center gap-3 rounded-xl border border-dashed px-5 py-8 text-center transition-colors",
          dragging ? "border-primary/60 bg-primary/5" : "border-border-strong bg-surface-raised/60",
        )}
      >
        <span
        ...
        <button
          ...
          className="inline-flex items-center rounded-lg border border-border-strong bg-surface px-3.5 py-2 text-xs font-semibold text-foreground transition-colors hover:border-primary/50"
        >
