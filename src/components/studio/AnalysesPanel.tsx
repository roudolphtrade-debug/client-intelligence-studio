...
/**
 * Analyses internes. Les notes internes sont visuellement isolées et
 * forcées en visibilité `internal` côté serveur : jamais exposées au client.
 */
export function AnalysesPanel({
  ...
  return (
    <div className="space-y-6">
      <Panel eyebrow="Analyse Sawaz" title="Constats, hypothèses et recommandations">
        {shared.length === 0 ? (
      ...
      <Panel
        ...
        aside={<StatusBadge tone="neutral">Jamais visible côté client</StatusBadge>}
      >
        {internal.length === 0 ? (
      ...
      {canWrite ? (
        <Panel eyebrow="Nouvelle entrée" title="Ajouter une analyse">
