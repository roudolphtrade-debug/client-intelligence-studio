...
/** Liste des Strategic Reviews d'un client + création depuis une collecte. */
export function ReviewsPanel({
  ...
  const mutation = useMutation({
    ...
    onSuccess: (res) => {
      ...
      toast.success("Review créée en brouillon");
  ...
  return (
    <Panel
      ...
      title="Workflow éditorial"
      aside={<StatusBadge tone="neutral">Aucun email, aucun accès client</StatusBadge>}
    >
      <p className="text-sm text-muted-foreground">
        Une Strategic Review n'est alimentée que par des métriques validées et des analyses
        destinées au client. Les notes internes et les métriques rejetées ou à vérifier ne peuvent
        pas y entrer.
      </p>
